 ...
 */
function deriveStickProps(sb: StickWithBox): StickProps {
...
// ---------------------------------------------------------------------------
// Crossings detection — minimal stub mirroring frame-context.ts geometry
// ---------------------------------------------------------------------------
...
export function runActionDefsPass(
  ...
  const SUPPRESSED_CLASSIFICATIONS = new Set<JointClassification>([
    "OnFlat - Standard",
    "OnFlat - Over",
    "OnFlat - Swaged",
    "OnFlat - Reversed",

 ...
 */
function opToRows(op, stickLength) {
...
function memberName(planName, frameName, stickName) {
 ...
 */
export function generateHowickCsv(doc, options = {}) {
...
function emitStick(lines, planName, frameName, stick, variant) {
 ...
 */
export function documentToHowickCsvs(doc, options = {}) {
    const out = {};
    for (const plan of doc.project.plans) {

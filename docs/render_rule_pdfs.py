...
EXAMPLES = {
    ...
    14: ("HG250030", "GF-LBW-89.075", "L24", "Kb2", "89mm Kb pattern copied from 70mm. Confirm or correct."),
    ...
    38: ("HG250082", "GF-NLBW-89.075", "N3", "B2", "89mm B with gauge<1.0 gate — single-corpus. Do thicker plates skip slab bolts?"),
    ...
    74: ("HG260002", "GF-LBW-89.075", "L24", "L3", "89mm sill — paired Dimple@58.5 always. Why 89mm specifically?"),
    75: ("HG260002", "GF-LBW-89.075", "L24", "L3", "Mirror of #74 at the end."),
    79: ("HG260044", "GF-TIN-70.075", "PC2-1", "R3", "Brace/Ribbon Swage 41 + Dimple 11 — single sample. Different from W?"),
    80: ("HG260044", "GF-TIN-70.075", "PC2-1", "R3", "Br/R InnerDimple at 11mm (vs 16.5 for studs)."),
    81: ("HG260044", "GF-TIN-70.075", "PC2-1", "R3", "Mirror of #79 at the end."),
    82: ("HG260044", "GF-TIN-70.075", "PC2-1", "R3", "Mirror of #80 at the end."),
    ...
    89: ("HG260001", "GF-TB2B-70.075", "TN6-6", "T4", "TB2B simplifier — untested at scale. Show the cap pattern."),
    90: ("HG260043", "GF-RP-89.115", "R1", "T1", "Linear-truss simplifier — bolt-hole at every web crossing. 1-job tuning."),
    91: ("HG260010", "GF-LBW-70.075", "L39", "S7", "Wall service simplifier — over-emits ~40× on small jobs."),
}

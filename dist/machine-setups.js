 ...
 */
export const SETUP_BY_PROFILE_WEB = {
    "70": "2",
    "75": "4",
    "78": "5",
    "89": "6",
 ...
 */
export function getMachineSetupForProfile(profileWeb) {
 ...
 */
export function getDefaultMachineSetup() {
 ...
 */
export function findSectionSetup(setup, sectionName) {
 ...
 */
export function findTool(setup, fName) {
 ...
 */
export function endClearanceSpan(setup) {
 ...
 */
export function dimpleEndOffset(setup) {
    const tab = findTool(setup, "Tab");
 ...
 */
export function lipNotchToolLength(setup) {

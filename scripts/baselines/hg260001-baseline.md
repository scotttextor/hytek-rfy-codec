...
**Overall: 85.70% matched** (15426/18000 ops)
Missing: 2574 (Detailer has, we lack) | Extras: 2266 (we emit, Detailer doesn't)

## Per-plan parity
| RFY | Parity | Matched | Ref | Missing | Extras |
|---|---:|---:|---:|---:|---:|
| HG260001_GF-RP-70.075.rfy | 48.9% | 488 | 997 | 509 | 491 |

...
**Overall: 91.38% matched** (16449/18000 ops)
Missing: 1551 (Detailer has, we lack) | Extras: 1509 (we emit, Detailer doesn't)
...
|---|---:|---:|---:|
| InnerDimple | 534 | 433 | 101 |
| LipNotch | 288 | 420 | -132 |
| Web | 234 | 161 | 73 |
| Swage | 203 | 229 | -26 |

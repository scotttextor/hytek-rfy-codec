...
**Overall: 93.03% matched** (16745/18000 ops)
Missing: 1255 (Detailer has, we lack) | Extras: 1224 (we emit, Detailer doesn't)

## Per-plan parity
| RFY | Parity | Matched | Ref | Missing | Extras |
|---|---:|---:|---:|---:|---:|
| HG260001_GF-RP-70.075.rfy | 74.8% | 746 | 997 | 251 | 249 |

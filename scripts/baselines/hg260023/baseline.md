...
**Overall: 84.60% matched** (16338/19312 ops)
Missing: 2974 (Detailer has, we lack) | Extras: 2830 (we emit, Detailer doesn't)

## Per-frame-type parity (14 plans grouped)
| Frame type | Plans | Parity | Matched | Ref | Missing | Extras |
|---|---:|---:|---:|---:|---:|---:|
| LBW | 4 | 91.2% | 7537 | 8263 | 726 | 823 |

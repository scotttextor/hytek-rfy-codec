...
**Overall: 85.69% matched** (15425/18000 ops)
Missing: 2575 (Detailer has, we lack) | Extras: 2268 (we emit, Detailer doesn't)

## Per-plan parity
| RFY | Parity | Matched | Ref | Missing | Extras |
|---|---:|---:|---:|---:|---:|
| HG260001_GF-RP-70.075.rfy | 48.8% | 487 | 997 | 510 | 493 |
